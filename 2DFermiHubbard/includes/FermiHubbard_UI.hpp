...
#include "config.hpp"
    ...
    #define FermiUI user_interface_dis<FermiHubbard>
#else
    #include "../../../QHamSolver/include/user_interface_sym.hpp"
    #define FermiUI user_interface_sym<FermiHubbard>
#endif  
#include "FermiHubbard.hpp"
// ----------------------------------------------------------------------------- UI QUANTUM SUN -----------------------------------------------------------------------------
...
namespace FermiHubbard_UI{
    ...
    protected:
        double J, Js, delta, deltas, U, Us, F, Fs;
        int Jn, deltan, Un, Fn;
